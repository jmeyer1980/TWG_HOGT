...
namespace TinyWalnutGames.UITKTemplates.Tools
{
    ...
    /// It will be kept alive across scene loads and will provide fast access to localization tables and fonts.
    /// This script must be placed after TMPro and before any game stuff runs. -100 seeems to be a good place.
    /// </summary>
    public class WebglLocalizationTableHolder : MonoBehaviour
    {
        // singleton pattern to ensure only one instance exists
        public static WebglLocalizationTableHolder Instance { get; private set; }
        [Tooltip("Assign one LocalizationTable per supported locale.")]
        public WebglLocalizationTable[] tables;
        ...
        public Dictionary<string, WebglLocalizationTable> TableByNameAndLocale { get; private set; }
        ...
        private void Awake()
        {
            ...
            // Ensure the script runs early in the initialization order
        ...
        {
            TableByNameAndLocale = new Dictionary<string, WebglLocalizationTable>();
            if (tables != null)
            {
