...
namespace TinyWalnutGames.UITKTemplates.Tools.Editor
{
    ...
    /// </summary>
    public class WebglLocalizationTableEditorWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Tiny Walnut Games/Localization/XLIFF to Scriptable Table Converter")]
        public static void ShowWindow()
        {
            GetWindow<WebglLocalizationTableEditorWindow>("XLIFF Table Converter");
        }
        ...
        private void CreateTablesForEachXLIFF()
        {
            ...
            foreach (var obj in droppedFiles)
            {
                ...
                if (File.Exists(path))
                {
                    ...
                    var table = ScriptableObject.CreateInstance<WebglLocalizationTable>();
        ...
        private void LoadXLIFFAuto(WebglLocalizationTable table, string xliffText, string filename)
        {
