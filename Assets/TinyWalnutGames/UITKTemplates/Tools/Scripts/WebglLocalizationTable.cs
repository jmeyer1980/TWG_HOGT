...
{
    [CreateAssetMenu(fileName = "LocalizationTable (WebGL)", menuName = "HOGT/Scriptable Objects/Localization/WebglScriptableTable")]
    public partial class WebglLocalizationTable : ScriptableObject
    {
        [System.Serializable]
