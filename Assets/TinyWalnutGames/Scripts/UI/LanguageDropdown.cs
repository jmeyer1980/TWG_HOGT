...
{   
    ...
    {
        [Tooltip("The UIDocument containing the dropdown field.")]
        ...
        private void Start()
        {
            ...
            _dropdown = root.Q<DropdownField>("dropdown_language");
            if (_dropdown == null)
            {
                Debug.LogError("dropdown_language not found.");
                return;
            }

            var languageDropdown = root.Q<VisualElement>("language_dropdown");
        ...
        private void OnDropdownValueChanged(ChangeEvent<string> evt)
        {
            ...
            // Fix: Use a static method in MainMenuController to raise the event
